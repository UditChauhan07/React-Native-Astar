...
import Speedometers, { Background, Arc, Needle, Progress, } from 'react-native-cool-speedometer';
...
const VehicleCompatibilityCheck = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = navigation.addListener('focus', () => {
            ...
            const per = Vehicle.compatibilitydetail.final_compatibility_percentage
            setper(per)
            console.warn(per);
            tryOut();
        });
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginLeft: -5 }}>
                        <View style={{ height: 30, width: 30, borderRadius: 30 / 2, backgroundColor: '#fff', alignItems: 'center', marginLeft: 20, marginTop: 23 }}>
                            <TouchableOpacity onPress={() => { test6() }}
                    ...
                    <View style={{ height: 52, backgroundColor: '#FFFFFFed', borderRadius: 12,marginLeft:10, marginRight:10, marginTop:10 }}>
                        <View style={{ backgroundColor: '#65096F', borderRadius: 12, marginTop: -10, marginLeft: 10, paddingBottom: 2, paddingTop: 2, paddingLeft: 10, paddingRight: 10, alignSelf: 'flex-start' }}>
                            <Text style={{ color: '#fff', fontSize: 10, textAlign: 'center', fontFamily: 'AvertaStd-Bold' }}>VEHICLE NAME</Text>
                        </View>
                        <Text style={{ color: '#3B2F5C', fontSize: 22, fontFamily: 'AvertaStd-Semibold', paddingLeft: 15, paddingTop: 5 }}>{Vehicle.compatibilitydetail.car_name}</Text>
                    </View>
                    <KeyboardAwareScrollView>
                        <View style={{ borderTopLeftRadius: 12, borderTopRightRadius: 12, backgroundColor: '#FFFFFFa1', marginLeft: 15, marginRight: 15, marginTop: 15, flex: 1 }}>
                            {per >= 71 &&
                                <View style={{ borderRadius: 12, backgroundColor: '#6CC335', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 20, paddingRight: 20 }}>
                                    <Text style={{ fontFamily: 'AvertaStd-Bold', color: '#fff', textAlign: 'center' }}>EXCELLENT</Text>
                                </View>}
                            {per <= 30 &&
                                <View style={{ borderRadius: 12, backgroundColor: '#EF3C25', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 20, paddingRight: 20 }}>
                                    <Text style={{ fontFamily: 'AvertaStd-Bold', color: '#fff', textAlign: 'center' }}>BAD</Text>
                                </View>}
                            {per >= 31 &&
                                <View>
                                    {per <= 70 &&
                                        <View style={{ borderRadius: 12, backgroundColor: '#FDA73C', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 20, paddingRight: 20 }}>
                            ...
                            {per >= 71 &&
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                    <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                        <Speedometers
                                            value={Vehicle.compatibilitydetail.final_compatibility_percentage}
                                            max={100}
                                            angle={180}
                                            duration={4000}
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '-30%' }}>
                                            <View style={{ marginTop: -15, flexDirection: 'row', alignItems: 'center' }}>
                                                <Text style={{ fontSize: 42, color: '#6CC335', fontWeight: 'bold' }}>{Vehicle.compatibilitydetail.final_compatibility_percentage}</Text>
                                    ...
                                    {per <= 70 &&
                                        <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                                ...
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '-30%' }}>
                                                    <View style={{ marginTop: -15, flexDirection: 'row', alignItems: 'center' }}>
                                                        <Text style={{ fontSize: 42, color: '#FDA73C', fontWeight: 'bold' }}>{Vehicle.compatibilitydetail.final_compatibility_percentage}</Text>
                            ...
                            {per <= 30 &&
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                    <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '-30%' }}>
                                            <View style={{ marginTop: -15, flexDirection: 'row', alignItems: 'center' }}>
                                                <Text style={{ fontSize: 42, color: '#EF3C25', fontWeight: 'bold' }}>{Vehicle.compatibilitydetail.final_compatibility_percentage}</Text>
                            ...
                            {Vehicle.compatibilitydetail.first_compatibility_processingbar != "" &&
                                <View>
                                    {Vehicle.compatibilitydetail.first_compatibility_processingbar <= 30 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Brand Compatibility</Text>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Bold' }}>{Vehicle.compatibilitydetail.first_compatibility_processingbar}%</Text>
                                                </View>
                                                <View style={{ height: 4.5, borderColor: '#000', borderRadius: 12, marginTop: 10, backgroundColor: '#EBEFF1' }}>
                                                    <SimpleGradientProgressbarView
                                                        ...
                                                        toColor="#EF3C25"
                                                        duration={4000}
                                                        progress={Vehicle.compatibilitydetail.first_compatibility_processingbar / 100}
                                    ...
                                    {Vehicle.compatibilitydetail.first_compatibility_processingbar >= 31 &&
                                        <View>
                                            {Vehicle.compatibilitydetail.first_compatibility_processingbar <= 70 &&
                                                <View style={{ marginLeft: 10, marginRight: 10 }}>
                                                    <View style={{ marginTop: 20 }}>
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                            <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Brand Compatibility</Text>
                                    ...
                                    {Vehicle.compatibilitydetail.first_compatibility_processingbar >= 71 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Brand Compatibility</Text>
                            ...
                            {Vehicle.compatibilitydetail.second_compatibility_processingbar != "" &&
                                <View>
                                    {Vehicle.compatibilitydetail.second_compatibility_processingbar <= 30 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Model Compatibility</Text>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Bold' }}>{Vehicle.compatibilitydetail.second_compatibility_processingbar}%</Text>
                                                </View>
                                                <View style={{ height: 4.5, borderColor: '#000', borderRadius: 12, marginTop: 10, backgroundColor: '#EBEFF1' }}>
                                                    <SimpleGradientProgressbarView
                                                        style={{ height: 5, marginVertical: 5, borderColor: '#000', borderRadius: 12, width: '100%', marginTop: -0.5, marginLeft: -1 }}
                                                        ...
                                                        toColor="#EF3C25"
                                                        duration={4000}
                                                        progress={Vehicle.compatibilitydetail.second_compatibility_processingbar / 100}
                                                        maskedCorners={[2, 2, 2, 2]}
                                                        cornerRadius={7.0}
                                                    />
                                                </View>
                                    ...
                                    {Vehicle.compatibilitydetail.second_compatibility_processingbar >= 31 &&
                                        <View>
                                            {Vehicle.compatibilitydetail.second_compatibility_processingbar <= 70 &&
                                                <View style={{ marginLeft: 10, marginRight: 10 }}>
                                                    <View style={{ marginTop: 20 }}>
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                            <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Model Compatibility</Text>
                                    ...
                                    {Vehicle.compatibilitydetail.second_compatibility_processingbar >= 71 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Vehicle Model Compatibility</Text>
                            ...
                            <View style={{ marginLeft: 10, marginRight: 10, marginBottom: 20 }}>
                                ...
                                <View style={{}}>
                                    {per >= 71 &&
                                        <Text style={{ fontSize: 16, color: '#000', fontFamily: "AvertaStd-Regular" }}>{Vehicle.compatibilitydetail.final_desc}</Text>
                                    }
                                    {per >= 31 &&
                                        <View>
                                            {per <= 70 &&
...
export default VehicleCompatibilityCheck