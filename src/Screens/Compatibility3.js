...
import { Business, Names } from '../ReduxFloder/action';
...
const Compatibility3 = ({ navigation }) => {
    ...
    const [patner, setpatner] = useState(1)
    ...
    const nav = () => {
        ...
        if(day == ""){
            alert('Please enter your incorporation date')
        }
        var day = Moment(date).format('YYYY-MM-DD')
        setloading(true)
        let bodyFormData = { 'userid': Data.userdetail.userid, 'type': 3, 'type_name': selectedLanguage, 'business_name': businessname, 'incorporation_date': day, 'partners': num }
        console.log(bodyFormData);
        axios({
            method: 'POST',
            url: `https://astar.7kstartup.com/public/api/businesscompatibilitycheck`, // Signup API
            data: bodyFormData,
            ...
            .then(({ data, status }) => {
                ...
                navigation.navigate('BusinessCompatibilityCheck')
                setloading(false)
            })
            .catch(error => {
                console.warn("error in business compatibilty check",error)
                setloading(false)
            })
    }
                    ...
                    <KeyboardAwareScrollView>
                        ...
                        <View style={{ backgroundColor: '#ffffffa1', borderRadius: 30, borderBottomWidth: 3, borderLeftColor: '#DA0AE4', borderRightColor: '#DA0AE4', borderBottomColor: '#DA0AE4', borderLeftWidth: 0.1, borderRightWidth: 0.1 }}>
                            <View style={{ borderRadius: 10, backgroundColor: '#73207C', marginLeft: 25, marginTop: -10, paddingTop: 2, paddingBottom: 2, paddingLeft: 10, paddingRight: 10, alignSelf: 'flex-start' }}>
                                <Text style={{ color: '#fff', textAlign: 'center', fontSize: 14, fontFamily: 'AvertaStd-Semibold' }}>Check Business</Text>
                            </View>
                            <View style={{ marginLeft: 25, marginTop: 10, borderBottomWidth: 0.2, marginRight: 25 }}>
                                <Text style={{ color: '#000', fontSize: 22, fontFamily: 'AvertaStd-Regular' }}>Type of Business</Text>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                                    <View style={{ width: '100%' }}>
                                        <Picker
                                            ...
                                            <Picker.Item label="Cooperative" value="Cooperative" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="Personal" value="Personal" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="Partnership" value="Partnership" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="Nonprofit Organization" value="Nonprofit Organization" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="It" value="It" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                        </Picker>
                                    </View>
                            ...
                            <View style={{ marginLeft: 25, marginTop: 5, marginBottom: 5, borderBottomWidth: 0.2, marginRight: 25 }}>
                                <Text style={{ color: '#000', fontSize: 22, fontFamily: 'AvertaStd-Regular' }}>Business Name</Text>
                                <TextInput style={{ borderBottomWidth: 1, color: '#DA0AE4', fontSize: 16, borderBottomColor: '#EBEBEB', fontFamily: 'AvertaStd-Regular' }}
                                    placeholder='Infotek Private Ltd.' placeholderTextColor='#828282'
                                    onChangeText={businessname => setbusinessname(businessname)}
                                    autoCapitalize='sentences'
                                    value={businessname} />
                            </View>
                            <View style={{ marginLeft: 25, marginTop: 5, marginBottom: 5, borderBottomWidth: 0.2, marginRight: 25 }}>
                                <Text style={{ color: '#000', fontSize: 22, fontFamily: 'AvertaStd-Regular' }}>Business Incorporation Date</Text>
                                ...
                                >
                                    <View style={{ flex: 0.45, backgroundColor: '#fff', borderRadius: 20, zIndex: 11111, borderBottomColor: '#DA0AE4', borderBottomWidth: 3, marginTop: -50, borderLeftWidth: 0.5, borderRightWidth: 0.5, borderColor: '#DA0AE4' }}>
                                        <Text style={{ color: '#3B2F5C', fontSize: 20, fontFamily: 'AvertaStd-Regular', paddingTop: 20, textAlign: 'center' }}>Business Incorporation Date</Text>
                                        <View style={{ paddingTop: 25 }}>
                                            <DatePicker date={date} onDateChange={setDate} androidVariant='iosClone' mode='date' textColor='#DA0AE4' />
                                        </View>
                                        <TouchableOpacity onPress={() => { hodedate() }} style={{ backgroundColor: '#65096F', borderRadius: 8, alignItems: 'center', alignSelf: 'center', marginTop: '15%', paddingTop: 5, paddingBottom: 5, paddingLeft: 55, paddingRight: 55 }}>
                                            <Text style={{ fontSize: 20, fontFamily: 'AvertaStd-Semibold', color: '#fff', alignSelf: 'center', padding: 2 }}>Confirm</Text>
                                        </TouchableOpacity>
                                    </View>
                                </Modal>
                            </View>
                            <View style={{ marginLeft: 25, marginTop: 5, borderBottomWidth: 0.2, marginRight: 25 }}>
                                <Text style={{ color: '#000', fontSize: 22, fontFamily: 'AvertaStd-Regular' }}>Number of Partners (if any)</Text>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                                    <View style={{ width: '100%' }}>
                                        <Picker
                                            selectedValue={num}
                                            ...
                                            <Picker.Item label="1" value="1" style={{ color: '#000', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="2" value="2" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="3" value="3" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="4" value="4" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="5" value="5" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                            <Picker.Item label="6" value="6" style={{ color: '#DA0AE4', fontFamily: 'AvertaStd-Regular', fontSize: 14 }} />
                                        </Picker>
                                    </View>
                                    <View style={{ alignSelf: 'center', marginLeft: -30 }}>
                                        <Entypo name="chevron-small-down" size={27} color="#65096F" />
