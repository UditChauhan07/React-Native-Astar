...
import { View, Text, SafeAreaView, TouchableOpacity, ImageBackground, Image, Animated } from 'react-native'
...
const BusinessCompatibilityCheck = ({ navigation }) => {
    ...
    const [progresbar1, setprogresbar1] = useState('')
    const [progresbar2, setprogresbar2] = useState('')
    const [progresbar3, setprogresbar3] = useState('')
    ...
    useEffect(() => {
        ...
        const per = Business.compatibilitydetail.final_compatibility_percentage
        setper(per)
        console.warn(per);
            ...
            <ImageBackground source={require('./assets/DashboardBackgroundImage.png')} style={{ flex: 1, zIndex: -222 }}>
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ height: 52, backgroundColor: '#FFFFFFed', borderRadius: 12, marginTop: 10, marginLeft: 10, marginRight: 10 }}>
                        <View style={{ backgroundColor: '#65096F', borderRadius: 12, marginTop: -10, marginLeft: 10, paddingBottom: 2, paddingTop: 2, paddingLeft: 10, paddingRight: 10, alignSelf: 'flex-start' }}>
                            <Text style={{ color: '#fff', fontSize: 10, textAlign: 'center', fontFamily: 'AvertaStd-Bold' }}>BUSINESS / TRADE</Text>
                        </View>
                        <Text style={{ color: '#3B2F5C', fontSize: 22, fontFamily: 'AvertaStd-Semibold', paddingLeft: 15, paddingTop: 5 }}>{Business.compatibilitydetail.business_name}</Text>
                    </View>
                    <KeyboardAwareScrollView>
                        <View style={{ borderTopLeftRadius: 12, borderTopRightRadius: 12, backgroundColor: '#FFFFFFa1', marginLeft: 15, marginRight: 15, marginTop: 20, flex: 1 }}>
                            {per >= 71 &&
                                <View style={{ borderRadius: 12, backgroundColor: '#6CC335', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 15, paddingRight: 15 }}>
                                    <Text style={{ fontFamily: 'AvertaStd-Bold', color: '#fff', textAlign: 'center' }}>EXCELLENT</Text>
                                </View>
                            }
                            {per <= 30 &&
                                <View style={{ borderRadius: 12, backgroundColor: '#EF3C25', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 15, paddingRight: 15 }}>
                            ...
                            {per >= 31 &&
                                <View>
                                    {per <= 70 &&
                                        <View style={{ borderRadius: 12, backgroundColor: '#FDA73C', alignSelf: 'center', marginTop: -10, paddingBottom: 2, paddingTop: 2, paddingLeft: 15, paddingRight: 15 }}>
                            ...
                            {per >= 71 &&
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                    <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                        <Speedometers
                                            value={Business.compatibilitydetail.final_compatibility_percentage}
                                            max={100}
                                            angle={180}
                                            duration={4000}
                                    ...
                                    {per <= 70 &&
                                        <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                                ...
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '-30%' }}>
                                                    <View style={{ marginTop: -15, flexDirection: 'row', alignItems: 'center' }}>
                                                        <Text style={{ fontSize: 42, color: '#FDA73C', fontWeight: 'bold' }}>{Business.compatibilitydetail.final_compatibility_percentage}</Text>
                            ...
                            {per <= 30 &&
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#DFDFF5', marginLeft: 10, marginRight: 10 }}>
                                    <View style={{ alignSelf: 'center', paddingTop: 10, position: 'relative', }}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '-30%' }}>
                                            <View style={{ marginTop: -15, flexDirection: 'row', alignItems: 'center' }}>
                                                <Text style={{ fontSize: 42, color: '#EF3C25', fontWeight: 'bold' }}>{Business.compatibilitydetail.final_compatibility_percentage}</Text>
                            ...
                            {Business.compatibilitydetail.first_compatibility_processingbar != "" &&
                                <View>
                                    {Business.compatibilitydetail.first_compatibility_processingbar <= 30 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Business Name Compatibility</Text>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Bold' }}>{Business.compatibilitydetail.first_compatibility_processingbar}%</Text>
                                                </View>
                                                <View style={{ height: 4.5, borderColor: '#000', borderRadius: 12, marginTop: 10, backgroundColor: '#EBEFF1' }}>
                                                    <SimpleGradientProgressbarView
                                                        ...
                                                        toColor="#EF3C25"
                                                        duration={4000}
                                                        progress={Business.compatibilitydetail.first_compatibility_processingbar / 100}
                                    ...
                                    {Business.compatibilitydetail.first_compatibility_processingbar >= 31 &&
                                        <View>
                                            {Business.compatibilitydetail.first_compatibility_processingbar <= 70 &&
                                                <View style={{ marginLeft: 10, marginRight: 10 }}>
                                                    <View style={{ marginTop: 20 }}>
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                            <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Business Name Compatibility</Text>
                                    ...
                                    {Business.compatibilitydetail.first_compatibility_processingbar >= 71 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Business Name Compatibility</Text>
                            ...
                            {Business.compatibilitydetail.second_compatibility_processingbar != "" &&
                                <View>
                                    {Business.compatibilitydetail.second_compatibility_processingbar <= 30 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Incorporation Date Compatibility</Text>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Bold' }}>{Business.compatibilitydetail.second_compatibility_processingbar}%</Text>
                                                </View>
                                                <View style={{ height: 4.5, borderColor: '#000', borderRadius: 12, marginTop: 10, backgroundColor: '#EBEFF1' }}>
                                                    <SimpleGradientProgressbarView
                                                        style={{ height: 5, marginVertical: 5, borderColor: '#000', borderRadius: 12, width: '100%', marginTop: -0.5, marginLeft: -1 }}
                                                        ...
                                                        toColor="#EF3C25"
                                                        duration={4000}
                                                        progress={Business.compatibilitydetail.second_compatibility_processingbar / 100}
                                                        maskedCorners={[2, 2, 2, 2]}
                                                        cornerRadius={7.0}
                                                    />
                                                </View>
                                    ...
                                    {Business.compatibilitydetail.second_compatibility_processingbar >= 31 &&
                                        <View>
                                            {Business.compatibilitydetail.second_compatibility_processingbar <= 70 &&
                                                <View style={{ marginLeft: 10, marginRight: 10 }}>
                                                    <View style={{ marginTop: 20 }}>
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                            <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Incorporation Date Compatibility</Text>
                                    ...
                                    {Business.compatibilitydetail.second_compatibility_processingbar >= 71 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Incorporation Date Compatibility</Text>
                            ...
                            {Business.compatibilitydetail.third_compatibility_processingbar != "" &&
                                <View>
                                    {Business.compatibilitydetail.third_compatibility_processingbar <= 30 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Type Compatibility</Text>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Bold' }}>{Business.compatibilitydetail.third_compatibility_processingbar}%</Text>
                                                </View>
                                                <View style={{ height: 4.5, borderColor: '#000', borderRadius: 12, marginTop: 10, backgroundColor: '#EBEFF1' }}>
                                                    <SimpleGradientProgressbarView
                                                        style={{ height: 5, marginVertical: 5, borderColor: '#000', borderRadius: 12, width: '100%', marginTop: -0.5, marginLeft: -1 }}
                                                        ...
                                                        toColor="#EF3C25"
                                                        duration={4000}
                                                        progress={Business.compatibilitydetail.third_compatibility_processingbar / 100}
                                                        maskedCorners={[2, 2, 2, 2]}
                                                        cornerRadius={7.0}
                                                    />
                                                </View>
                                    ...
                                    {Business.compatibilitydetail.third_compatibility_processingbar >= 31 &&
                                        <View>
                                            {Business.compatibilitydetail.third_compatibility_processingbar <= 70 &&
                                                <View style={{ marginLeft: 10, marginRight: 10 }}>
                                                    <View style={{ marginTop: 20 }}>
                                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                            <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Type Compatibility</Text>
                                    ...
                                    {Business.compatibilitydetail.third_compatibility_processingbar >= 71 &&
                                        <View style={{ marginLeft: 10, marginRight: 10 }}>
                                            <View style={{ marginTop: 20 }}>
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <Text style={{ color: '#000', fontFamily: 'AvertaStd-Regular' }}>Type Compatibility</Text>
                            ...
                            <View style={{ marginLeft: 10, marginRight: 10, marginBottom: 10 }}>
                                <View style={{ marginTop: 20 }}>
                                    <Text style={{ fontSize: 20, color: '#3B2F5C', fontFamily: 'AvertaStd-Semibold' }}>Compatibility Description</Text>
                                </View>
                                <View style={{}}>
                                    {per >= 71 &&
                                        <Text style={{ fontSize: 16, color: '#000', fontFamily: "AvertaStd-Regular" }}>{Business.compatibilitydetail.businessdesc}</Text>
                                    }
                                    {per >= 31 &&
                                        <View>
                                            {per <= 70 &&
...
export default BusinessCompatibilityCheck