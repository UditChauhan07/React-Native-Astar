...
const SpouseCompatibilityCheck = ({ navigation }) => {
    ...
    const [per, setper] = useState(Spouse.otheruser_detail.final_usercompatiblitypercentage)
    ...
    const NameReading = () => {
        navigation.navigate('NameReading1')
    }
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginLeft: -5 }}>
                        <View style={{ height: 30, width: 30, borderRadius: 30 / 2, backgroundColor: '#fff', alignItems: 'center', marginLeft: 20, marginTop: 23 }}>
                            <TouchableOpacity onPress={() => { test9() }}
                    ...
                    <View style={{ backgroundColor: '#ffffffa1', borderRadius: 12, margin: 10 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 5, paddingRight: 5 }}>
                            <View style={{ flexDirection: 'row', backgroundColor: '#65096F', height: 20, alignItems: 'center', borderRadius: 12, paddingLeft: 10, paddingRight: 10, marginTop: -10, }}>
                                <Text style={{ color: '#fff', fontSize: 10, fontFamily: 'AvertaStd-Semibold' }}>DOB: <Text style={{ color: '#fff', fontSize: 10 }}>{(Moment(Spouse.loginuser_detail.loginuserdob).format('DD/MMM/YYYY')).toUpperCase()}</Text></Text>
                            </View>
                            <View style={{ flexDirection: 'row', backgroundColor: '#65096F', height: 20, alignItems: 'center', borderRadius: 12, paddingLeft: 10, paddingRight: 10, marginTop: -10, }}>
                                <Text style={{ color: '#fff', fontSize: 10, fontFamily: 'AvertaStd-Semibold' }}>DOB: <Text style={{ color: '#fff', fontSize: 10 }}>{(Moment(Spouse.otheruser_detail.otherpersondob).format('DD/MMM/YYYY')).toUpperCase()}</Text></Text>
                            </View>
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <Text style={{ fontSize: 22, color: '#3B2F5C', fontFamily: 'AvertaStd-Semibold', paddingLeft: 10, maxWidth: '50%' }}>{Spouse.loginuser_detail.loginusername}</Text>
                            <Text style={{ fontSize: 30, color: '#007AFF', fontFamily: 'AvertaStd-Semibold', alignSelf: 'center', marginTop: -5 }}>|</Text>
                            <Text style={{ fontSize: 22, color: '#3B2F5C', fontFamily: 'AvertaStd-Semibold', maxWidth: '50%', paddingRight: 10, textAlign:'right' }}>{Spouse.otheruser_detail.otherpersonname}</Text>
                        </View>
                    </View>
                    <KeyboardAwareScrollView>
                        <View style={{ borderRadius: 200, borderWidth: .5, width: 317, height: 317, alignSelf: 'center', borderColor: '#DFDFF5', marginBottom: 20, marginLeft: -10 }}>
                            <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                                <View style={{ flexDirection: 'column', }}>
                                    <View style={{ marginLeft: '65%', width: 40, alignItems: 'center', }}>
                                        {Spouse.loginuser_detail.planet == 'Saturn' &&
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Moon' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Jupiter' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Uranus' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Mercury' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Neptune' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Mars' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Earth' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Venus' &&
                                            <View style={{ alignItems: 'center' }}>
                                        ...
                                        {Spouse.loginuser_detail.planet == 'Sun' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/sun-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Sun</Text>
                                            </View>}
                                    </View>
                                    <View style={{ marginTop: 100, alignItems: 'center', marginLeft: -80, alignItems: 'center' }}>
                                        <Text style={{ width: 34, textAlign: 'center', height: 34, backgroundColor: '#fff', borderRadius: 7, shadowColor: '#000', shadowOpacity: 0.2, fontFamily: 'AvertaStd-Bold', fontSize: 27, color: '#65096F', marginTop: -2, fontWeight: '700', paddingTop: 4 }}>{Spouse.loginuser_detail.primaryno}</Text>
                                        <Text style={{ maxWidth: '20%', fontSize: 10, fontFamily: 'AvertaStd-Regular', color: '#444444' }}>Primary Number</Text>
                                    </View>
                                    <View style={{ marginTop: '35%', marginLeft: '70%', width: 34, height: 32, borderRadius: 7, backgroundColor: "#fff", alignItems: 'center', alignContent: 'center' }}>
                                        {Spouse.loginuser_detail.zodiacsign == "CANCER" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-cancer" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "ARIES" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-aries" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "TAURUS" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-taurus" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "GEMINI" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-gemini" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "LEO" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-leo" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "VIRGO" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-virgo" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "LIBRA" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-libra" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "SCORPIO" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-scorpio" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "SAGITTARIUS" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-sagittarius" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "CAPRICORN" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-capricorn" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "AQUARIUS" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-aquarius" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.loginuser_detail.zodiacsign == "PISCES" &&
                                            <View style={{ alignSelf: 'center' }}>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                    ...
                                    <View style={{ alignSelf: 'center', marginLeft: '55%' }}>
                                        <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular', textAlign: 'center' }}>{Spouse.loginuser_detail.zodiacsign}</Text>
                                    </View>
                                </View>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    <View style={{ marginLeft: '-45%', alignItems: 'center', width: 40 }}>
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Saturn' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Saturn-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Saturn</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Moon' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Moon.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Moon</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Jupiter' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/space-nasa-GIF-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Jupiter</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Uranus' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Uranus-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Uranus</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Mercury' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Mercury-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Mercury</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Neptune' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Neptune-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Neptune</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Mars' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/mars-GIF-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Mars</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Earth' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/Earth--unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Earth</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Venus' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/venus-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Venus</Text>
                                            </View>}
                                        {Spouse.otheruser_detail.planet_detail.planet_name == 'Sun' &&
                                            <View style={{ alignItems: 'center' }}>
                                                <Image source={require('./assets/sun-unscreen.gif')} style={{ height: 35, width: 35, }} />
                                                <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular' }}>Sun</Text>
                                            </View>}
                                    ...
                                    <View style={{ marginTop: 105, marginLeft: 35, }}>
                                        <Text style={{ width: 34, textAlign: 'center', height: 34, backgroundColor: '#fff', borderRadius: 7, fontSize: 27, fontFamily: 'AvertaStd-Bold', color: '#65096F', marginTop: -2, fontWeight: '700', paddingTop: 4 }}>{Spouse.otheruser_detail.primary_detail.number}</Text>
                                        <Text style={{ maxWidth: '50%', marginRight: '10%', fontSize: 10, color: '#444444' }}>Primary Number</Text>
                                    </View>
                                    <View style={{ marginTop: '57%', marginLeft: -50, backgroundColor: '#fff', borderRadius: 7, width: 34, height: 32, alignItems: 'center' }}>
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "CANCER" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-cancer" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "ARIES" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-aries" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "TAURUS" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-taurus" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "GEMINI" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-gemini" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "LEO" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-leo" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "VIRGO" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-virgo" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "LIBRA" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-libra" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "SCORPIO" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-scorpio" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "SAGITTARIUS" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-sagittarius" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "CAPRICORN" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-capricorn" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "AQUARIUS" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-aquarius" size={20} color="#65096F" />
                                                </View>
                                            </View>}
                                        {Spouse.otheruser_detail.zodiac_detail.zodiac_sign == "PISCES" &&
                                            <View>
                                                <View style={{ alignSelf: 'center', paddingTop: 5 }}>
                                                    <Icon name="zodiac-pisces" size={20} color="#65096F" />
                                                </View>
                                    ...
                                    <View style={{ alignSelf: 'center', marginLeft: '-150%', }}>
                                        <Text style={{ fontSize: 10, color: '#444444', fontFamily: 'AvertaStd-Regular', textAlign: 'center' }}>{Spouse.otheruser_detail.zodiac_detail.zodiac_sign}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                        <View style={{ margin: 10, backgroundColor: '#FFFFFFa1', borderRadius: 8 }}>
                            <View style={{ margin: 10, flexDirection: 'row', alignSelf: 'center' }}>
                                <View style={{ justifyContent: 'flex-start', marginLeft: -5, marginTop: -10 }}>
                                    <Text style={{ color: '#65096F', fontSize: 30, textAlign: 'center', fontFamily: 'PassionOneBold', transform: [{ rotate: "180deg" }] }}>"</Text>
                                </View>
                                <View style={{ alignSelf: 'center', marginTop: -5 }}>
                                    <Text style={{ color: '#65096F', fontSize: 19, textAlign: 'center', fontFamily: 'AvertaStd-Regular', maxWidth: '95%' }}>{Spouse.otheruser_detail.love_scale}</Text>
                                </View>
                                <View style={{ justifyContent: 'flex-end', marginLeft: -15, marginTop: 20 }}>
                                    <Text style={{ color: '#65096F', fontSize: 30, fontFamily: 'PassionOneBold' }}>"</Text>
                                </View>
                            </View>
                        </View>
                        <View style={{ margin: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
                            <TouchableOpacity onPress={() => NameReading()}>
                                <View style={{ borderRadius: 8, paddingTop: 5, paddingBottom: 5, paddingLeft: 5, paddingRight: 5, backgroundColor: '#65096F', alignItems: 'center' }}>
                                    <Text style={{ fontSize: 14, fontFamily: 'AvertaStd-Semibold', color: '#fff', maxWidth: '50%', textAlign: 'center' }}>MORE ABOUT {(Spouse.otheruser_detail.otherpersonname).toUpperCase()}</Text>
                                </View>
                            </TouchableOpacity>
                        ...
                        <View style={{ alignContent: 'center',backgroundColor:'#FFFFFFe1', margin:10 }}>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.fav_numbers.split(',').join(', ')}</Text>
                                    ...
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.unfav_numbers.split(',').join(', ')}</Text>
                                    <View style={{ width:'33%', borderRadius: 12, borderColor: '#DB7DC5', borderWidth: .5, alignItems: 'center', alignSelf: 'center' }}>
                                        <Text style={{ color: '#60096A', textAlign: 'center', padding: 10, fontFamily: 'AvertaStd-Regular', fontSize: 13 }}>Non-Favorable Numbers</Text>
                                    </View>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.fav_days.split(',').join(', ')}</Text>
                                    <View style={{ width:'33%', borderRadius: 12, borderColor: '#DB7DC5', borderWidth: .5, alignItems: 'center', alignSelf: 'center' }}>
                                        <Text style={{ color: '#60096A', textAlign: 'center', padding: 10, fontFamily: 'AvertaStd-Regular', fontSize: 13 }}>Favorable Days</Text>
                                    </View>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.days.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.unfav_days.split(',').join(', ')}</Text>
                                    <View style={{ width:'33%', borderRadius: 12, borderColor: '#DB7DC5', borderWidth: .5, alignItems: 'center', alignSelf: 'center' }}>
                                        <Text style={{ color: '#60096A', textAlign: 'center', padding: 10, fontFamily: 'AvertaStd-Regular', fontSize: 13 }}>Non-Favorable Days</Text>
                                    </View>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.days.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.fav_months.split(',').join(', ')}</Text>
                                    ...
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.months.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom:10, marginTop:10 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>

                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.unfav_months.split(',').join(', ')}</Text>
                                    <View style={{ width:'33%', borderRadius: 12, borderColor: '#DB7DC5', borderWidth: .5, alignSelf: 'center', alignItems: 'center' }}>
                                        <Text style={{ color: '#60096A', textAlign: 'center', padding: 10, fontFamily: 'AvertaStd-Regular', fontSize: 13 }}>Non-Favorable Months</Text>
                                    </View>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.months.split(',').join(', ')}</Text>
                                </View>
                            </View>
                            <View style={{ margin: 10, marginBottom: 30 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', alignContent: 'center' }}>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.loginuser_detail.lucky_gems.split(',').join(', ')}</Text>
                                    <View style={{ width:'33%', borderRadius: 12, borderColor: '#DB7DC5', borderWidth: .5, alignItems: 'center', alignSelf: 'center' }}>
                                        <Text style={{ color: '#60096A', textAlign: 'center', padding: 10, fontFamily: 'AvertaStd-Regular', fontSize: 13 }}>Lucky Gems</Text>
                                    </View>
                                    <Text style={{ color: '#60096A', textAlign: 'center', maxWidth: '30%', borderBottomWidth: 1, borderBottomColor: '#DB7DC5', fontFamily: 'AvertaStd-Regular',width:'33%' }}>{Spouse.otheruser_detail.luckyparameters.lucky_gems.split(',').join(', ')}</Text>
                                </View>
                            </View>
                        </View>
                    </KeyboardAwareScrollView>
            ...
            <Modal visible={isele}
                ...
                <View style={{ margin: 25, flex: 1, display: 'flex', }}>
                    <View style={{ flex: 0.9, backgroundColor: '#fff', borderRadius: 12, shadowColor: '#3B2F5C', shadowOpacity: 0.2, elevation: 10, shadowRadius: 12 }}>
                        <View style={{ margin: 25, alignSelf: 'center', flex: 1 }}>
                            <Text style={{ color: '#3B2F5C', fontSize: 24, fontWeight: '500' }}>Compatibility between {Spouse.loginuser_detail.loginusername} & {Spouse.otheruser_detail.otherpersonname}  </Text>
                            <KeyboardAwareScrollView>
                                <Text style={{ color: '#000', fontSize: 16, paddingTop: 10, fontFamily: 'AvertaStd-Regular' }}>
                                    {Spouse.otheruser_detail.relation_desc}
                                </Text>
                        ...
                        <View style={{ alignSelf: 'flex-end' }}>
                            <TouchableOpacity onPress={() => Eback()}
                                style={{ width: 157, height: 39, borderColor: '#65096F', borderWidth: 3, borderRadius: 8, margin: 10 }}>
                                <Text style={{ fontSize: 16, fontWeight: '500', color: '#65096F', textAlign: 'center', paddingTop: 5 }}>I UNDERSTAND</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
...
export default SpouseCompatibilityCheck