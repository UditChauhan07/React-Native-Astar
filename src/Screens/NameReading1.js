...
import { View, Text, SafeAreaView, TouchableOpacity, Image, ImageBackground, Animated, ScrollView, FlatList } from 'react-native'
            ...
            <ImageBackground source={require('./assets/Astar8.png')} style={{ flex: 1, zIndex: -222 }}>
                    ...
                    <View style={{ alignSelf: 'center', marginLeft: 10, }}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ backgroundColor: '#65096F', borderRadius: 12, alignSelf: 'flex-end', paddingLeft: 10, paddingRight: 10, marginLeft: '10%', flexDirection: 'row' }}>
                                ...
                                <Text style={{ fontFamily: 'AvertaStd-Regular', color: '#fff', fontSize: 10 }}>{Moment(Spouse.otheruser_detail.otherpersondob).format('Do MMM, YYYY')}</Text>
                            </View>
                        </View>
                        <Text style={{ fontFamily: 'AvertaStd-Black', fontSize: 38, color: '#3B2F5C', fontWeight: '900' }}>{Spouse.otheruser_detail.otherpersonname}</Text>
                    </View>
                </View>
                <View style={{ backgroundColor: '#fff', shadowColor: '#000', shadowOpacity: 0.2, elevation: 5 }}>
                    <View style={{ backgroundColor: '#fff', justifyContent: 'space-around', flexDirection: 'row', marginLeft: 10, marginRight: 10 }}>
                        ...
                        <View style={{ alignItems: 'center', alignSelf: 'center', marginLeft: 15, marginRight: 15, marginTop: 10, marginBottom: 10 }}>
                            <FlatList
                                data={Spouse.otheruser_detail.Module_types}
                    ...
                    <View style={{ backgroundColor: '#fff', justifyContent: 'space-around', flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: '#444444', marginLeft: 10, marginRight: 10, marginBottom: 10 }}>
                        ...
                        <View style={{ alignItems: 'center', alignSelf: 'center', marginLeft: 15, marginRight: 15, marginTop: 10, marginBottom: 10 }}>
                            <View style={{ backgroundColor: '#fff', borderRadius: 7, width: 100, height: 75, justifyContent: 'center', borderWidth: 0.5, alignItems: 'center', alignSelf: 'center', shadowColor: '#000', shadowOpacity: 0.2, elevation: 2, borderColor: '#D3D3D3', }}>
                                <View style={{ alignItems: 'center' }}>
                                    <Text style={{ fontFamily: 'AvertaStd-Bold', color: '#65096F', fontSize: 65, marginTop: -5 }}>{Spouse.otheruser_detail.name_reading.Chald_number}</Text>
                                </View>
                            </View>
                ...
                <ScrollView>
                    ...
                    <View style={{ margin: 10 }}>
                        <View style={{ backgroundColor: '#fff', borderRadius: 12, paddingTop: 10, paddingLeft: 10, paddingRight: 10, paddingBottom: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row', paddingTop: 10 }}>
                                <Text style={{ fontFamily: 'AvertaStd-Black', color: '#000', lineHeight: 20 }}>{Spouse.otheruser_detail.name_reading.Chald_positive_title} :<Text style={{ fontFamily: 'AvertaStd-Regular', color: '#6B6B6B', lineHeight: 20, maxWidth: '85%' }}>{Spouse.otheruser_detail.name_reading.Chald_positive_desc}</Text></Text>

                            </View>
                            <View style={{ flexDirection: 'row', paddingBottom: 10, paddingTop: 10 }}>
                                <Text style={{ fontFamily: 'AvertaStd-Black', color: '#000', lineHeight: 20 }}>{Spouse.otheruser_detail.name_reading.Chald_negative_title} :<Text style={{ fontFamily: 'AvertaStd-Regular', color: '#6B6B6B', lineHeight: 20, maxWidth: '85%' }}>{Spouse.otheruser_detail.name_reading.Chald_negative_desc}</Text></Text>
                        ...
                        <View style={{ backgroundColor: '#fff', borderRadius: 12, paddingTop: 10, paddingLeft: 10, paddingRight: 10, paddingBottom: 10, marginTop: 10 }}>
                                ...
                                <View>
                                    <View style={{ paddingLeft: 10, paddingBottom: 5 }}>
                                        <View style={{ paddingTop: 5, paddingRight: 15, flexDirection: 'row', }}>
                                            ...
                                            {Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[0] &&
                                                <View style={{ paddingRight: 5, display: 'flex', }}>
                                                    ...
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#fff', fontFamily: 'AvertaStd-Semibold', }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[0]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[2] &&
                                                <View style={{ paddingRight: 5, display: 'flex' }}>
                                                    <Image source={require('./assets/fav-red.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#fff', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[2]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[4] &&
                                                <View style={{ paddingRight: 5 }}>
                                                    <Image source={require('./assets/fav-darkBlue.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#fff', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[4]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[6] &&
                                                <View style={{ paddingRight: 5, display: 'flex' }}>
                                                    <Image source={require('./assets/fav-Sky-Blue.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#fff', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.favparameter.numbers[6]}</Text>
                                                    </View>
                                                </View>}
                                        </View>
                                    </View>
                                    <View style={{ marginBottom: 30, paddingLeft: 10 }}>
                                        <View style={{ paddingTop: 5, paddingRight: 15, flexDirection: 'row', }}>
                                            ...
                                            {Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[0] &&
                                                <View style={{ paddingRight: 5, display: 'flex', }}>
                                                    <Image source={require('./assets/Unfav-blue.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#066AFF', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[0]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[2] &&
                                                <View style={{ paddingRight: 5, display: 'flex' }}>
                                                    <Image source={require('./assets/unfav-red.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#FF173A', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[2]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[4] &&
                                                <View style={{ paddingRight: 5 }}>
                                                    <Image source={require('./assets/unfav-darkBlue.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#022457', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[4]}</Text>
                                                    </View>
                                                </View>}

                                            {Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[6] &&
                                                <View style={{ paddingRight: 5, display: 'flex' }}>
                                                    <Image source={require('./assets/unfav-Sky-Blue.png')} style={{ width: 34.41, height: 31.51 }} />
                                                    <View style={{ marginTop: -30, marginLeft: 10, paddingTop: 2, paddingLeft: 1 }}>
                                                        <Text style={{ fontSize: 20, color: '#009E99', fontFamily: 'AvertaStd-Semibold' }}>{Spouse.otheruser_detail.favunfav_parameters.unfavparameters.numbers[6]}</Text>
                                                    </View>
                                                </View>}
                                        </View>
                                    </View>
                            ...
                            <Text style={{ fontFamily: 'AvertaStd-Regular', color: '#6B6B6B', fontSize: 12, lineHeight: 20 }}>{Spouse.otheruser_detail.primary_detail.description}</Text>
                            {/* <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
                                <View style={{ margin: 5 }}>
                                    <Image source={require('./assets/Fill-hrt.png')} style={{ width: 18, height: 18 }} />
                                </View>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) =>
                                    <View style={{ }}>
                                        ...
                                        {item.module_type == 15 &&
                                            <Text style={{ fontFamily: 'AvertaStd-Regular', color: '#6B6B6B', lineHeight: 20, paddingTop: 10, textAlign:'left' }}>{item.description}</Text>}
                                    </View>}
                            />
                            {/* <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
                                <View style={{ margin: 5 }}>
