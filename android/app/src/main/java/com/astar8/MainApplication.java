...
import com.astar8.newarchitecture.MainApplicationReactNativeHost;
...
public class MainApplication extends Application implements ReactApplication {
  ...
  packages.add(new LottiePackage());return packages;}
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.astar8.ReactNativeFlipper");
        aClass
